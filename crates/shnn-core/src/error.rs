...
// From trait implementations for connectivity errors
impl From<crate::connectivity::sparse::SparseConnectivityError> for SHNNError {
    fn from(err: crate::connectivity::sparse::SparseConnectivityError) -> Self {
        SHNNError::Generic { message: "Sparse connectivity error" }
    }
}

impl From<crate::connectivity::matrix::MatrixConnectivityError> for SHNNError {
    fn from(err: crate::connectivity::matrix::MatrixConnectivityError) -> Self {
        SHNNError::Generic { message: "Matrix connectivity error" }
    }
}

impl From<crate::connectivity::graph::GraphConnectivityError> for SHNNError {
    fn from(err: crate::connectivity::graph::GraphConnectivityError) -> Self {
        SHNNError::Generic { message: "Graph connectivity error" }
    }
}

impl From<crate::connectivity::hypergraph::HypergraphConnectivityError> for SHNNError {
    fn from(err: crate::connectivity::hypergraph::HypergraphConnectivityError) -> Self {
        SHNNError::Generic { message: "Hypergraph connectivity error" }
    }
}
